...
public class ImportController extends BaseController {
    ...
    public ModelAndView importTowns() throws IOException {
        String townsJsonFileContent = this.townService.readTownsJsonFile();
        return super.view("json/import-towns", "towns", townsJsonFileContent);
    }
    ...
    public ModelAndView importBranches() throws IOException {
        String branchesJsonFileContent = this.branchService.readBranchesJsonFile();
        return super.view("json/import-branches", "branches", branchesJsonFileContent);
    }

    @PostMapping("/branches")
    public ModelAndView importBranchesConfirm() throws IOException {
        System.out.println(this.branchService.importBranches());
    ...
    public ModelAndView importEmployeeCards() throws IOException {
        String employeeCardsJsonFileContent = this.employeeCardService.readEmployeeCardsJsonFile();
        return super.view("json/import-employee-cards", "employeeCards", employeeCardsJsonFileContent);
    }

    @PostMapping("/employee-cards")
    public ModelAndView importEmployeeCardsConfirm() throws IOException {
        System.out.println(this.employeeCardService.importEmployeeCards());
